...
+ (NSArray *)interstitialAds
{
    ...
    return @[
    [MPAdInfo infoWithTitle:@"Mintegral InterstitialVideo Ad" ID:@"b8b79afa3815465e859be943dc98468b" type:MPAdInfoInterstitial],
...
//      
    return @[
    [MPAdInfo infoWithTitle:@"Mintegral RewardVideo" ID:@"68e9e6415c494228a44eb7b6536f11a4" type:MPAdInfoRewardedVideo],
...
+(NSString *)initUnitId
{
    return @"b8b79afa3815465e859be943dc98468b";
}
